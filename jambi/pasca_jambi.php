...
if(isset($_GET['cari']))
{
    $data = mysqli_query($koneksi,"SELECT * FROM jambi_pasca where no_jaringan like '%$_GET[cari]%' OR pelanggan like '%$_GET[cari]%' OR lokasi like '%$_GET[cari]%' OR provider like '%$_GET[cari]%' OR no_kartu like '%$_GET[cari]%' OR status_layanan like '%$_GET[cari]%' OR perangkat like '%$_GET[cari]%'");
...
{
    $data = mysqli_query($koneksi,"SELECT * FROM jambi_pasca");
    $last_search = '';
}
        ...
        <div class="container-fluid px-xl-5">
          <section class="py-5">
            <h2 class="text-center">AREA JAMBI</h2>
               ...
               <form action="pasca_jambi.php" method="get" style="text-align: right;">
                 ...
                 <!-- tambah tombol reset -->
                 <a class="btn btn-sm btn-warning" href="pasca_jambi.php">X</a>
              </form>
              <br>
  ...
  ?>
            ...
            <table class="table table-striped table-bordered table-condensed">
                      ...
                      <tbody>
                        ...
                        while ($jambi=mysqli_fetch_array($data))
                        ...
                        <tr>
                          ...
                          <td width="45">
                            <a href="pasca_ubah.php?no_jaringan=<?php echo $jambi['no_jaringan']; ?>">
                          ...
                          <td width="45">
                          <a href="pasca_hapus.php?no_jaringan=<?php echo $jambi['no_jaringan']; ?>">
