<?php
	...
	$query = "INSERT INTO plg_pra (`no_jaringan`,`pelanggan`,`lokasi`,`provider`,`no_kartu`,`status_layanan`,`perangkat`,`awal_pengisian`,`masa_aktif`,`status`) VALUES ('$no_jaringan','$pelanggan','$lokasi','$provider','$no_kartu','$status_layanan','$perangkat','$awal_pengisian','$masa_aktif','$status')";
