      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
          <section class="py-5">
            ...
            <table class="table table-striped table-bordered table-condensed">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo date('d-m-Y', strtotime($lampung['awal_pengisian'])); ?></td>
                          <td><?php echo date('d-m-Y', strtotime($lampung['masa_aktif'])); ?></td>
                          <td><?php echo $lampung['status']; ?></td>
                          <td width="45">
                            <a href="lampung_ubah.php?no_jaringan=<?php echo $lampung['no_jaringan']; ?>">
                          ...
                          <td width="45">
                          <a href="lampung_hapus.php?no_jaringan=<?php echo $lampung['no_jaringan']; ?>">
            ...
            <center>
                <a href="lampung_form.php" class="btn btn-lg btn-info">Add</a>
                <a href="lampung_export.php" class="btn btn-lg btn-info">Export</a>
            </center>
