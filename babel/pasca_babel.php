...
if(isset($_GET['cari']))
{
    $data = mysqli_query($koneksi,"SELECT * FROM babel_pasca where no_jaringan like '%$_GET[cari]%' OR pelanggan like '%$_GET[cari]%' OR lokasi like '%$_GET[cari]%' OR provider like '%$_GET[cari]%' OR no_kartu like '%$_GET[cari]%' OR status_layanan like '%$_GET[cari]%' OR perangkat like '%$_GET[cari]%'");
...
{
    $data = mysqli_query($koneksi,"SELECT * FROM babel_pasca");
    $last_search = '';
}
    ...
    <header class="header">
      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
          <section class="py-5">
            <h2 class="text-center">AREA BABEL</h2>

               <form action="pasca_babel.php" method="get" style="text-align: right;">
                 ...
                 <!-- tambah tombol reset -->
                 <a class="btn btn-sm btn-warning" href="pasca_babel.php">X</a>
              </form>
              <br>
  ...
  ?>
            ...
            <table class="table table-striped table-bordered table-condensed">
                      ...
                      <tbody>
                        ...
                        while ($babel=mysqli_fetch_array($data))
                        ...
                        <tr>
                          ...
                          <td width="45">
                            <a href="pasca_ubah.php?no_jaringan=<?php echo $babel['no_jaringan']; ?>">
                          ...
                          <td width="45">
                          <a href="pasca_hapus.php?no_jaringan=<?php echo $babel['no_jaringan']; ?>">
          ...
          <?php } ?>
            <center>
                <a href="pasca_form.php" class="btn btn-lg btn-info">Add</a>
                <a href="pasca_export.php" class="btn btn-lg btn-info">Export</a>
            </center>
