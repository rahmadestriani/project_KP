      ...
      <div class="page-holder w-100 d-flex flex-wrap">
        <div class="container-fluid px-xl-5">
          <section class="py-5">
            ...
            <table class="table table-striped table-bordered table-condensed">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="45">
                            <a href="babel_ubah.php?no_jaringan=<?php echo $babel['no_jaringan']; ?>">
                          ...
                          <td width="45">
                          <a href="babel_hapus.php?no_jaringan=<?php echo $babel['no_jaringan']; ?>">
            ...
            <center>
                <a href="babel_form.php" class="btn btn-lg btn-info">Add</a>
                <a href="babel_export.php" class="btn btn-lg btn-info">Export</a>
            </center>
