<?php
	...
	$query = "UPDATE bengkulu_pra SET `pelanggan`='$pelanggan',`lokasi`='$lokasi',`provider`='$provider',`no_kartu`='$no_kartu',`status_layanan`='$status_layanan',`perangkat`='$perangkat',`awal_pengisian`='$awal_pengisian',`masa_aktif`='$masa_aktif',`status`='$status' WHERE `no_jaringan`='$no_jaringan'";
